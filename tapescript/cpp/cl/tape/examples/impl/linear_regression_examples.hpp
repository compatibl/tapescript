...
#ifndef cl_tape_examples_impl_linear_regression_examples_hpp
#define cl_tape_examples_impl_linear_regression_examples_hpp

#define CL_BASE_SERIALIZER_OPEN
#include <cl/tape/tape.hpp>
#include "linear_regression.hpp"
#include "linear_regression_examples_impl.hpp"
...
namespace cl
{
    ...
    inline void linear_regression_examples()
    {
        std::ofstream of("output/linear_regression_output.txt");
...
#endif // cl_tape_examples_impl_linear_regression_examples_hpp
