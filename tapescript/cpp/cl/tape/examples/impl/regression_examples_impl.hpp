...
namespace cl
{
    ...
    void check_derivatives_dA(LinearRegression& lin_regr, std::vector<tvalue>& forw, double eps)
    {
        int n = lin_regr.GetN();
    ...
    // Check derivatives with respect to a.
    void check_derivatives_dA(LinearRegression& lin_regr, std::vector<double>& forw, double eps)
    {
        int n = lin_regr.GetN();
    ...
    void check_derivatives_dB(LinearRegression& lin_regr, std::vector<tvalue>& forw, double eps)
    {
        int n = lin_regr.GetN();
    ...
    // Check derivatives with respect to b.
    void check_derivatives_dB(LinearRegression& lin_regr, std::vector<double>& forw, double eps)
    {
        int n = lin_regr.GetN();
    ...
    void check_derivatives_dC(LinearRegression& lin_regr, std::vector<tvalue>& forw, double eps)
    {
        int n = lin_regr.GetN();
    ...
    // Check derivatives with respect to c.
    void check_derivatives_dC(LinearRegression& lin_regr, std::vector<double>& forw, double eps)
    {
        int n = lin_regr.GetN();
    ...
    void check_derivatives_dX(LinearRegression& lin_regr, std::vector<tvalue>& forw, int i, double eps)
    {
        int n = lin_regr.GetN();
    ...
    // Check derivatives with respect to x_i.
    void check_derivatives_dX(LinearRegression& lin_regr, std::vector<double>& forw, int i, double eps)
    {
        int n = lin_regr.GetN();
    ...
    void check_derivatives_dY(LinearRegression& lin_regr, std::vector<tvalue>& forw, int i, double eps)
    {
        int n = lin_regr.GetN();
    ...
    // Check derivatives with respect to y_i.
    void check_derivatives_dY(LinearRegression& lin_regr, std::vector<double>& forw, int i, double eps)
    {
        int n = lin_regr.GetN();
