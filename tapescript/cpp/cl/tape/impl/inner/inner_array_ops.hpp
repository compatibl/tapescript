...
namespace cl
{
    namespace tapescript
    {
        ...
        // Returns reversed vector.
        template <class Array>
        inline tape_double<inner_array<Array>> reverse_vec(const tape_double<inner_array<Array>>& x)
        {
        ...
        // Returns sum of vector elements.
        template <class Array>
        inline tape_double<inner_array<Array>> sum_vec(const tape_double<inner_array<Array>>& x)
        {
        ...
        // Concatenation of two vectors.
        template <class Array>
        inline tape_double<inner_array<Array>> conc_vec(const tape_double<inner_array<Array>>& x, const tape_double<inner_array<Array>>& y)
        {
